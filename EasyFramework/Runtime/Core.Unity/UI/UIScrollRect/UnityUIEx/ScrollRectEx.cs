...
//     {
//         // Add by mengchengxin 
//         public bool IsPauseDrag { get; private set; }
//         public event Action<Vector2> OnUpdateContentPos;
//
//
//         /// <summary>
...
//
//                 // Add by mengchengxin 
//                 OnUpdateContentPos?.Invoke(position);
//             }
//         }
//
...
//
//         /// <summary>
//         /// EasyCHelper function to update the previous data fields on a ScrollRect. Call this before you change data in the ScrollRect.
//         /// </summary>
...
//                 UpdateBounds();
//             }
//             OnUpdateContentPos?.Invoke(m_Content.anchoredPosition);
//         }
//
