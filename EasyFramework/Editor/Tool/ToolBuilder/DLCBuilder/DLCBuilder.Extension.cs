...
{
    class DLCBuilderExtension : IToolEvent<ToolBuilder>, IToolEvent<DLCBuilder>
    {
        int IToolEvent<ToolBuilder>.ToolOrder => 1;
        void IToolEvent<ToolBuilder>.OnExecute() => DLCBuilder.Instance.Execute();
        void IToolEvent<DLCBuilder>.OnExecute() => DLCBuilder.Instance.BuildBySettings();
    }
