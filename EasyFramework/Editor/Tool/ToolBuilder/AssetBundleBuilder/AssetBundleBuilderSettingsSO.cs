...
{
    [CreateAssetMenu(menuName = "EasyFramework/AssetBuilder/AssetBundleBuilderSettings")]
    public class AssetBundleBuilderSettingsSO : ScriptableObject, IAssetBundleBuilderSettings
    {
