...
namespace EasyFramework.Editor
{
    ...
    class SVCCollectorAssetBundleBuilderBefore : IToolEvent<AssetBundleBuilder>
    {
        ...
        public void OnExecute()
        {
            if (SVCCollectorSettings.Instance.preprocessShaders)
            {
                ...
                SVCCollectorPreprocessShaders.ShaderBuildInfo = SVCCollectorExtension.CreateShaderVariantCollectionInfo();
                SVCCollectorPreprocessShaders.ShaderVariantsBuildList.Clear();
            }
        }
    }
    
    class SVCCollectorAssetBundleBuilderAfter : IToolEvent<AssetBundleBuilder>
    {
        public int Order => 999;
        public void OnExecute()
        {
