...
namespace EasyFramework
{
    public class UIAdapterBehaviour : MonoBehaviour
    {
        ...
        public UIAdapterType adapterType = UIAdapterType.FitOutside;
        ...
        public void Refresh()
        {
            ...
            if (adapterType == UIAdapterType.Stretch)
            {
            ...
            switch (adapterType)
            {
                case UIAdapterType.FitInside:
                    scaleFactor = Mathf.Min(scaleX, scaleY);
                    break;
                case UIAdapterType.FitOutside:
